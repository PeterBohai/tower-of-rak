...
def menu_options_controls():
    ...
    while not menu_close:
        ...
        left_button.update(player_events)
        right_button.update(player_events)
        up_button.update(player_events)
        down_button.update(player_events)
        grab_button.update(player_events)
        inventory_button.update(player_events)
        next_button.update(player_events)
        esc_button.update(player_events)
